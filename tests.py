...
indicies, samples = ReadSignalFile("add.txt")
...
indicies, samples = ReadSignalFile("subtract.txt")
...
indicies, samples = ReadSignalFile("mul5.txt")
...
indicies, samples = ReadSignalFile("advance3.txt")
ShiftSignalByConst(3, indicies, samples)

indicies, samples = ReadSignalFile("delay3.txt")
ShiftSignalByConst(-3, indicies, samples)
...
indicies, samples = ReadSignalFile("folding.txt")
